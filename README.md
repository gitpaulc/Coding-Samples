...
<p>
  <button>
  <a href="https://github.com/gitpaulc/Coding-Samples/tree/dev/computational_geometry" alt="Computational Geometry"><img alt="Computational Geometry" src="ui/geometry.png" height="14%" width="10%"/></a>
  </button>
  <button>
  <a href="https://github.com/gitpaulc/Coding-Samples/tree/dev/graphing_math" alt="Graphing Math"><img alt="Graphing Math" src="ui/graphing.png" height="11%" width="10%"/></a>
  </button>
  <button>
  ...
  <button>
  <a href="https://github.com/gitpaulc/Coding-Samples/tree/dev/mesh_renderer" alt="Mesh Renderer"><img alt="MeshRenderer" src="ui/meshing.png" height="11%" width="10%"/></a>
  </button>
</p>
