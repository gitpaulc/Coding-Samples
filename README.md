...
<p>
  ...
  <button>
  <a href="https://github.com/gitpaulc/Coding-Samples/tree/dev/graphing_math" alt="Graphing Math"><img alt="Graphing Math" src="ui/graphing.png" height="20%" width="10%"/></a>
  </button>
  <button>
  <a href="https://github.com/gitpaulc/Coding-Samples/tree/dev/computational_biology" alt="Computational Biology"><img alt="ComputationalBiology" src="ui/biology.png" height="20%" width="10%"/></a>
  </button>
  <button>
